...
data class Libro(
    ...
    companion object {
        // --- Recomendados ---
        val Libro1 = Libro(1, "Cien años de soledad", "García Márquez", "url_portada_1", Categoria.CienciaFiccion)
        ...
        val LibrosLeidosEjemplo = listOf(
            Libro1.copy(id=4, titulo="Crimen y Castigo", autor="Dostoievski", categoria = Categoria.CienciaFiccion),
        ...
        val LibrosFuturasEjemplo = listOf(
            Libro1.copy(id=7, titulo="El Quijote", autor="Cervantes", categoria = Categoria.CienciaFiccion),
